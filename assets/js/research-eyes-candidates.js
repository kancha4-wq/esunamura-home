(function () {
  ...
  const items = [
    ...
    },
    {
      ...
      positive_prompt: "(large eyes:1.30), big anime eyes, wide open eyes, large round irises, expressive innocent gaze",
    ...
    },
    {
      ...
      positive_prompt: "(slender eyes:1.30), long narrow eye shape, horizontal almond eyes, refined calm gaze, slightly narrow eyelids",
    ...
    },
    {
      ...
      positive_prompt: "(droopy eyes:1.30), downturned outer eye corners, soft droopy eyelids, gentle sad-looking eyes, mild gaze",
    ...
    },
    {
      ...
      positive_prompt: "(upturned eyes:1.30), raised outer eye corners, slightly sharp upturned gaze, confident eyes, defined upper eyelids",
