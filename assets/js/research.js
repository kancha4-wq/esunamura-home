(function () {
  ...
  const candidateLabelTranslations = {
    ...
    large_eyes: { en: "Large Eyes", zh: "大眼", ko: "큰 눈" },
    cat_eyes: { en: "Cat Eyes", zh: "猫眼", ko: "고양이눈" },
    round_eyes: { en: "Round Eyes", zh: "圆眼", ko: "둥근 눈" },
    slender_eyes: { en: "Slender Eyes", zh: "细长眼", ko: "가늘고 긴 눈" },
    droopy_eyes: { en: "Droopy Eyes", zh: "下垂眼", ko: "처진 눈" },
    upturned_eyes: { en: "Upturned Eyes", zh: "上挑眼", ko: "올라간 눈" },
    ...
    detailed_iris: { en: "Detailed Iris", zh: "细致虹彩", ko: "섬세한 홍채" },
  ...
  const shareText = {
    ...
    cosplay: "SDXL / illustriousXL向けのコスプレプロンプト100件を公開しました。\nファンタジー、和風、職業、SF、ステージ衣装を画像とプロンプトで比較できます。",
